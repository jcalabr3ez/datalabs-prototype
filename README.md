...
| DL-05 Massachusetts Public Pensions | `/pensions/` | `netlify/functions/dl05-answers.json` | Research pass when PERAC or CTHRU posts a new year. Runbook: `scripts/dl05-research-pass.md` |
