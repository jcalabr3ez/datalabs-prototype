...
{"type":"answer","tool_id":"DL-10","text":"the answer, maximum three sentences, plain language","view":"one of: home | policy | report","followups":["two short related questions the dataset can also answer"]}
   DL-10 answer rules: use ONLY the DL-10 dataset, never outside knowledge. Every figure cites its source id in parentheses, e.g. (SRC-FL-01) for county premiums, (SRC-FL-02) for Citizens figures, (SRC-FL-03) for litigation shares, (SRC-FL-04) for risk transfer. Values you compute from the series (differences, percent changes) say derived, e.g. (derived, SRC-FL-02). Prefer the precomputed values in citizens_key_facts and county_rankings over your own arithmetic. Dollar figures are annual average premiums for the county, not quotes. view selection: home for what households pay, counties, Citizens size, flood; policy for market health, litigation, takeouts, risk transfer; report for reform grades.
