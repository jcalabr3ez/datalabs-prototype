# DL-04 research pass: local runbook
...
Paste this prompt into Claude Code:
    ...
    (DL-04). The canonical ledger is netlify/functions/dl04-answers.json; the
    ...
    4. Apply factual updates to netlify/functions/dl04-answers.json ONLY
